...
import { Heart, Star, Clock, User as UserIcon, Tag, AlertTriangle, Download } from 'lucide-react';
...
export function SharedSkillDetail({ id, backPath }: SharedSkillDetailProps) {
